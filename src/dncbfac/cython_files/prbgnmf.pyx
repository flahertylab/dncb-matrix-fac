...
cdef class PRBGNMF(MCMCModel):
    ...
    def __init__(self, int I, int J, int K, double bm=1., double bu=1., 
        ...
        super(PRBGNMF, self).__init__(seed=seed, n_threads=n_threads)
...
def initialize_PRBGNMF_with_BGNMF(model, data_IJ, verbose=0, n_itns=50):
